...
function ProductDetails({ products, product }) {
    ...
    //Destructuring useStateContext according to our need
                ...
                <div className="product-detail-desc">
                    ...
                    <div className="quantity">
                        ...
                        <p className="quantity-desc">
                            <span className="minus" onClick={decreseQuantity}><AiOutlineMinus /></span>
...
export async function getStaticPaths() {
    ...
    // fetch all products but don't return the data of all products just return the current slug property
